...
const Register: React.FC<RegisterPage> = ({ setRegister, setRegisterSuccess, setTitle }) => {
  ...
  return (
    <div className="inputContainer">
      <h1>Registration</h1>
      <InputLabelMain error={isErr} type={'login'} label={'Login'} size={'medium'} event={handlerLogin} />
      <InputLabelMain error={isErr} type={'name'} label={'Name'} size={'medium'} event={handlerName} />
      <InputLabelMain error={isErr} type={'surname'} label={'Surname'} size={'medium'} event={handlerSurname} />
      <InputLabelMain error={isEmailErr} type={'email'} label={'Email'} size={'medium'} event={handlerEmail} />
      ...
      <div className="registerBox" onClick={() => setRegister(false)}>
