            ...
            {isLoading ? <MainSpinner isLoading={isLoading} />
                ...
                <div className="inputContainer">
                    <div className="titleContainer">
                        ...
                        <p>Enter a new secure password. Your password must include at least one capital letter and one lowercase letter, one special character and a minimum length of 8 characters.</p>
                    </div>
                    <InputLabelPassword
                        error={isErr}
                        isShow={isEyeFirst}
                    ...
                    <div className="buttonsContainer">
                        ...
                        >Confirm password</LoadingButton>
                    </div>
                </div>
            }
        </div>
